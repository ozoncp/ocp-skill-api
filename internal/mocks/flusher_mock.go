...
// Source: github.com/ozoncp/ocp-skill-api/internal/flusher (interfaces: Flusher)
...
func (m *MockFlusher) Flush(arg0 context.Context, arg1 []models.Skill) ([]models.Skill, error) {
	m.ctrl.T.Helper()
